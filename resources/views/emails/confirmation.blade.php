...
<div class="container" style="border: 2px solid lightgray;">
    ...
    <div class="row" style="border-bottom: 2px solid lightgray;">
        <div class="col-md-12">
            ...
            <br>
            <p style="font-size: 14px;padding-left: 2%;"> Use below code to verify your account:</p>
        </div>
    </div>
    ...
    <div class="row" style="border-bottom: 2px solid lightgray;">
        <div class="col-md-12">
            <p style="font-size: 14px;padding-left: 2%;padding-top: 2%;"> If you did not create account with this email, please ignore this email.</p>
            <br>
